...
/*:
 * @plugindesc Adds delay and fade-in function to each image on the title screen.
 * @author Shio_inu
 *
 *
 * @param Delay BG1
 * @desc Number of frames for showing background 1
 * @default 0
 *
 * @param Fade BG1
 * @desc Number of frames for fading of background 1
 * @default 60
 *
 * @param Delay BG2
 * @desc Number of frames for showing background 2
 * @default 60
 *
 * @param Fade BG2
 * @desc Number of frames for fading of background 2
 * @default 60
 *
 * @param Delay Title
 * @desc Number of frames to start showing the title
 * @default 120
 *
 * @param Fade Title
 * @desc Number of frames for the title to fade
 * @default 60
 *
 * @param Delay Command
 * @desc Number of frames to show the command
 * @default 180
 *
 * @param Pass To Decide
 * @desc Setting whether to skip the fade sequence. 1: Enable skip, 0: Disable skip
 * @default 1
 * 
 * @help last update : 26th Jun 2017 v1.01
 *
 */
 ...
 * @default 1
 * @help last update : 2017/06/26 v1.01
 *
 */
(function(){
